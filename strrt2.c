...
/**
 * write_str - To write a string to file descriptor
 * @fd: File descriptor to be written into
...
/**
 * _strdup - Handles repeated elements within a string
...
/**
 * _strtok_r - Splits a string into tokens using a delimiter (safe)
 * @str: The string to split
 * @delim: The delimiter character used to tokenise the string
